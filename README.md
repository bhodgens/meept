...
| **Models** | ✅ Capability resolver + natural-language reassignment ("use GLM for coding") + failover | ✅ Per-session `/model`; 200+ providers; fallback | ✅ 75+ providers; Zen gateway; fallback | ⚠️ Claude family (third-party keys optional) | ✅ Model-agnostic: Claude, GPT, Gemini, Ollama, vLLM | ✅ Multi-vendor + Composer; Auto mode | ✅ **Rust:** OpenAI-compatible + fallback chain. **Python:** 15+ providers; team-as-router | ✅ 60+ providers; role pins (smol / slow / plan / advisor) |
