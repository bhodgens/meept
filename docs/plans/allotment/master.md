...
| 02-tactical-wiring.md | COMPLETE | 1 | 4ba3ad41 — provider dep + ScheduleReadySteps batching + continuation persistence + ExecutorModelRef + daemon closure; legacy byte-identity pinned; one informational fmt.Errorf note (non-blocking) |
