...
| D12-a | Tree 05 deviation (recorded 2026-09-01): LM Studio ships discovery-only — NO static catalog entries (loaded models vary). "Catalog" from D12 is satisfied by registry entry + /v1/models + /api/v0/models discovery + docs; config/models.json5 never gains lmstudio rows. | orchestrator, tree 05 close-out |
