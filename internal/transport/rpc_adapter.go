...
func (a *rpcAdapter) QueryMemory(query string, limit int) (*types.MemoryQueryResponse, error) {
	return a.client.QueryMemory(query, limit)
}
func (a *rpcAdapter) GetRecentMemories(limit int) (*types.MemoryQueryResponse, error) {
	return a.client.GetRecentMemories(limit)
}
func (a *rpcAdapter) ListWorkers() (*types.WorkerListResponse, error) { return a.client.ListWorkers() }
func (a *rpcAdapter) GetQueueStats() (*types.QueueStatsResponse, error) {
	return a.client.GetQueueStats()
}
func (a *rpcAdapter) ListQueueJobs(state string, limit int) (*types.QueueJobListResponse, error) {
	return a.client.ListQueueJobs(state, limit)
}
func (a *rpcAdapter) ListTasks(state string, limit int) (*types.TaskListResponse, error) {
	return a.client.ListTasks(state, limit)
}
...
func (a *rpcAdapter) CreateSession(name string, cwd string) (*types.Session, error) {
	return a.client.CreateSession(name, cwd)
}
...
func (a *rpcAdapter) SaveSessionMessages(sessionID string, messages []types.SessionMessage) error {
	return a.client.SaveSessionMessages(sessionID, messages)
}
func (a *rpcAdapter) UpdateSessionDescription(sessionID, description string) error {
	return a.client.UpdateSessionDescription(sessionID, description)
}
...
func (a *rpcAdapter) GetSessionChildTasks(sessionID string) ([]string, error) {
	return a.client.GetSessionChildTasks(sessionID)
}
func (a *rpcAdapter) ListTasksExtended() (*types.TaskExtendedListResponse, error) {
	return a.client.ListTasksExtended()
}
