...
------------ | ------------- | ------------- | -------------
**Allowed** | **bool** |  | 
**Reasonomitempty** | Pointer to **string** |  | [optional] 
...
GetReasonomitempty returns the Reasonomitempty field if non-nil, zero value otherwise.

### GetReasonomitemptyOk

`func (o *CheckResponse) GetReasonomitemptyOk() (*string, bool)`

GetReasonomitemptyOk returns a tuple with the Reasonomitempty field if it's non-nil, zero value otherwise
and a boolean to check if the value has been set.
...
SetReasonomitempty sets Reasonomitempty field to given value.
