...
void main() {
  ...
  test(
    'getApiKey returns String? (nullable) — compiles when assigned to null',
    () {
      ...
      if (AppConstants.defaultApiKey.isEmpty) {
        expect(
          ...
          isNull,
          reason:
              'getApiKey should return null when no key is configured '
  ...
  test('defaultApiKey is empty in test builds (no --dart-define)', () {
    ...
    expect(
      ...
      '',
      reason:
          'Tests should not have the dev key injected; if this fails, '
